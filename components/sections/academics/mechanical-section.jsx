      ...
      <section className="py-24 relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <img src="/images/hero-2.jpg" alt="Mechanical Projects" className="w-full h-full object-cover" />
      ...
      <section className="py-24 relative overflow-hidden bg-card/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="absolute inset-0 opacity-[0.08] [background-image:linear-gradient(to_right,#3b82f6_1px,transparent_1px),linear-gradient(to_bottom,#3b82f6_1px,transparent_1px)] [background-size:36px_36px]" />

              <div className="relative w-full h-full flex items-center justify-center">
                <svg className="absolute inset-0 w-full h-full pointer-events-none">
                  <defs>
                    <linearGradient id="mechanicalLineGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <div className="space-y-10">
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="text-sm font-bold uppercase tracking-widest">Machine Intelligence</span>
                </motion.div>
                <h2 className="text-4xl font-bold text-foreground sm:text-6xl leading-tight tracking-tight">
                  The Mechanical Core of <br />
                  <span className="text-primary italic">Future Industry</span>
                </h2>
                <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
                  Engage with an interactive mechanical-tech ecosystem where design, automation, thermal science and production engineering work in sync.
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-6 border-t border-border/50">
                <div className="group cursor-default">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-2xl font-black text-foreground tracking-tight group-hover:text-primary transition-colors">Smart Manufacturing</p>
                  </div>
                  <p className="text-sm text-muted-foreground leading-relaxed">Building efficient, data-driven and performance-focused manufacturing systems.</p>
                </div>
                <div className="group cursor-default">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="h-2 w-2 rounded-full bg-accent animate-pulse" />
                    <p className="text-2xl font-black text-foreground tracking-tight group-hover:text-primary transition-colors">Reliable Systems</p>
                  </div>
                  <p className="text-sm text-muted-foreground leading-relaxed">Engineering robust machines and thermal systems with safety and efficiency.</p>
                </div>
              </div>

              <div className="pt-8">
                <button className="group relative inline-flex items-center gap-4 text-primary font-bold text-lg">
                  <span className="border-b-2 border-primary/30 group-hover:border-primary transition-all pb-1">Explore Mechanical Systems</span>
      ...
      >
        <div className="flex flex-col items-center gap-10 rounded-[40px] border border-border/40 bg-card/40 backdrop-blur-xl p-8 sm:flex-row sm:p-12 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex-1 text-center sm:text-left relative z-10">
            <p className="text-xs font-bold uppercase tracking-[0.5em] text-primary mb-3">Ready to Engineer Motion?</p>
            <h3 className="text-3xl font-bold text-foreground tracking-tight sm:text-5xl leading-tight">Build the Future with Mechanical Engineering</h3>
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed max-w-2xl">
              Join Satpuda Mechanical Engineering to design advanced machines, smarter systems and efficient industrial solutions.
            </p>
          </div>
