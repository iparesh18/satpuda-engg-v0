  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <main>
        ...
        <motion.section
          className="relative overflow-hidden border-b border-border/70 bg-card/40 pt-16 pb-10 sm:pt-18 lg:pt-20 lg:pb-12"
        ...
        <AboutSection className="pb-16 sm:pb-18 lg:pb-20 pt-10 sm:pt-14 lg:pt-16" />
      </main>
      <Footer />
    </div>
  );
