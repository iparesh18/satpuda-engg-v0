...
import { Calendar, MapPin, Clock, ArrowRight, Tag, BookOpen, AlertCircle } from "lucide-react";
...
export function EventDetailsDialog({ isOpen, onClose, event, onRegister }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-xl bg-background border border-border p-0 overflow-hidden rounded-3xl shadow-2xl">
        {/* Cover Photo */}
        ...
        {/* Modal Action Footer */}
        <DialogFooter className="bg-secondary/20 border-t border-border/40 p-6 flex flex-col sm:flex-row gap-3">
          <Button
            type="button"
            variant="outline"
            onClick={onClose}
