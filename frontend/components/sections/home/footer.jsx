            ...
            >
              ...
              <div className="mt-4 grid gap-2 sm:grid-cols-2 xl:grid-cols-4">
                {contactItems.map((item) => (
                  <div key={item.label} className="flex items-start gap-3 rounded-xl border border-border/60 bg-slate-50 px-3 py-2.5">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-0.5 break-words text-xs sm:text-sm font-medium leading-snug text-foreground">
                        {item.value}
                      </p>
                    </div>
                  </div>
          ...
          <div className="mt-4 flex flex-col gap-3 border-t border-border pt-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center justify-center gap-4 lg:justify-start">
              <img
                ...
                className="w-60 sm:w-52 lg:w-72 xl:w-80 h-auto object-contain"
                loading="lazy"
              />
            </div>
