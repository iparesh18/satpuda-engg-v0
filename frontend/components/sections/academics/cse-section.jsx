...
const facultyMembers = [
  {
    ...
    subject: "OOPS",
    degree: "M.Tech, PhD",
    image: "/images/ajay_garg.png",
    badgeTitle: "10+ Years in",
    badgeSubtitle: "AI Research",
  ...
  {
    name: "Prof. Deepak Kumar Thakur",
    role: "Assistant Professor",
    subject: "Data Structures & Algorithms",
    degree: "M.Tech",
    image: "/images/deepak sir.png",
    badgeTitle: "Algorithm",
  ...
  },
  {
    ...
    badgeTitle: "Network",
    badgeSubtitle: "Administration",
    titlePart1: "Routing",
    titlePart2: "Data.",
    titlePart3: "Connecting",
    titlePart4: "Devices.",
  },
  {
    name: "Mr. Javed Khan",
    ...
    subject: "Computer Networks",
    degree: "M.Tech, (PhD)",
    image: "/images/javed khan.png",
    badgeTitle: "Network",
    badgeSubtitle: "Security Expert",
    titlePart1: "Securing",
    titlePart2: "Packets.",
  ...
  {
    name: "Prof. Dolchand Neware",
    role: "Assistant Professor",
    subject: "Computer Networks",
    degree: "M.Tech",
    image: "/images/faculty_female.png",
    badgeTitle: "Network",
    badgeSubtitle: "Design Specialist",
    titlePart1: "Optimizing",
    titlePart2: "Flow.",
    titlePart3: "Enhancing",
    titlePart4: "Speed.",
  },
  {
    name: "Prof. Rashmi Dhurve",
    role: "Assistant Professor",
    subject: "Computer Networks",
    degree: "M.Tech",
    image: "/images/faculty_female.png",
    badgeTitle: "Wireless",
    badgeSubtitle: "Networks Expert",
    titlePart1: "Connecting",
    titlePart2: "Without Limits.",
    titlePart3: "Innovating",
    titlePart4: "Communication.",
  },
  {
    name: "Prof. Ankita Namdev",
    role: "Assistant Professor",
    subject: "Computer Networks",
    degree: "M.Tech",
    image: "/images/faculty_female.png",
    badgeTitle: "Protocol",
    badgeSubtitle: "Analyst",
  ...
  },
  {
    ...
    subject: "Computer Networks",
    degree: "M.Tech",
    image: "/images/tripti-mdm.png",
    badgeTitle: "Network",
    badgeSubtitle: "Architect",
    titlePart1: "Structuring",
    titlePart2: "Networks.",
    titlePart3: "Building",
    titlePart4: "Backbones.",
  },
  {
    ...
    badgeTitle: "Data Comm.",
    badgeSubtitle: "Expert",
    titlePart1: "Transmitting",
    titlePart2: "Data.",
    titlePart3: "Bridging",
    titlePart4: "Nodes.",
  },
  ...
  {
    name: "Miss Himanshi Bisen",
    role: "HR Operation",
    subject: "Operating System",
    degree: "M.Tech",
    image: "/images/himanshi-mam.png",
    badgeTitle: "Kernel",
    badgeSubtitle: "Development",
    titlePart1: "Managing",
    titlePart2: "Resources.",
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                {/* Connection Lines (Static SVG with animated pulses) */}
                ...
                <Magnetic intensity={0.2}>
                  ...
                  >
                    <Cpu className="h-14 w-14 text-white animate-pulse" />
                ...
                {/* Orbital Tech Nodes */}
                {[
                  { icon: Database, label: "Big Data", angle: 0 },
                  { icon: ShieldCheck, label: "Security", angle: 72 },
                  { icon: Globe, label: "Network", angle: 144 },
                  { icon: Terminal, label: "DevOps", angle: 216 },
                  { icon: Lightbulb, label: "AI/ML", angle: 288 },
                ].map((node, i) => (
                  <motion.div
                    key={node.label}
            ...
            <div className="space-y-10">
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="text-sm font-bold uppercase tracking-widest">Digital Ecosystem</span>
                </motion.div>
                <h2 className="text-4xl font-bold text-foreground sm:text-6xl leading-tight tracking-tight">
                  The Neural Hub of <br />
                  <span className="text-primary italic">Innovation</span>
                </h2>
                <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
                  Dive into our Quantum Neural Core, where we visualize the complex interplay of data, security, and intelligence that defines modern computing.
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-6 border-t border-border/50">
                <div className="group cursor-default">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-2xl font-black text-foreground tracking-tight group-hover:text-primary transition-colors">Cognitive AI</p>
                  </div>
                  <p className="text-sm text-muted-foreground leading-relaxed">Developing next-generation neural architectures for real-world intelligence.</p>
                </div>
                <div className="group cursor-default">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="h-2 w-2 rounded-full bg-accent animate-pulse" />
                    <p className="text-2xl font-black text-foreground tracking-tight group-hover:text-primary transition-colors">Hyper-Cloud</p>
                  </div>
                  <p className="text-sm text-muted-foreground leading-relaxed">Scaling infrastructure beyond limits with distributed cloud ecosystems.</p>
                </div>
              </div>
              
              <div className="pt-8">
                <button className="group relative inline-flex items-center gap-4 text-primary font-bold text-lg">
                  <span className="border-b-2 border-primary/30 group-hover:border-primary transition-all pb-1">Explore Visual Systems</span>
      ...
      >
        <div className="flex flex-col items-center gap-10 rounded-[40px] border border-border/40 bg-card/40 backdrop-blur-xl p-8 sm:flex-row sm:p-12 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex-1 text-center sm:text-left relative z-10">
            <p className="text-xs font-bold uppercase tracking-[0.5em] text-primary mb-3">Ready to Build the Future?</p>
            <h3 className="text-3xl font-bold text-foreground tracking-tight sm:text-5xl leading-tight">Join a community of innovators & creators</h3>
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed max-w-2xl">
              Your journey in technology starts here at Satpuda College. Empower your potential with cutting-edge knowledge and practical expertise.
            </p>
          </div>
