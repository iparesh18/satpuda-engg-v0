...
const hodData = {
  ...
  image: "/images/chabbu-mine.webp",

  titlePart1: "Pioneering",
  titlePart2: "Earth Sciences.",
  titlePart3: "Leading",
  titlePart4: "Mining Innovations.",
};
...
const facultyMembers = [
  ...
  // },
  {
    ...
    degree: "MBA",
    image:  "/images/new-poonam-mine.webp",
    badgeTitle: "Mine",
    badgeSubtitle: "Environment",
    titlePart1: "Protecting",
    titlePart2: "Environment.",
              ...
              <div className="contents lg:flex lg:flex-col lg:justify-between lg:col-span-7 space-y-10 lg:space-y-0">
                <div className="order-1 lg:order-none space-y-4 flex flex-col items-center lg:items-start text-center lg:text-left">
                  ...
                  <h2 className="text-4xl font-bold text-foreground sm:text-5xl leading-tight tracking-tight">
                    The Experts That <br />
                    <span className="text-primary">Drive Mining Forward</span>
                  </h2>
                  <p className="text-muted-foreground leading-relaxed max-w-2xl text-sm sm:text-base">
                    Our Mining Engineering faculty blend academic excellence with extensive field experience, mentoring students to become innovative and safety-driven mining professionals.
                  </p>
                </div>
