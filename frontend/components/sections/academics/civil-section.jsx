            ...
            >
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                <svg className="absolute inset-0 w-full h-full pointer-events-none">
                  <defs>
                    <linearGradient id="civilLineGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <Magnetic intensity={0.2}>
                  ...
                  >
                    <Landmark className="h-14 w-14 text-white animate-pulse" />
                    <div className="absolute inset-0 rounded-3xl bg-white/20 animate-ping" />
                  </motion.div>
                </Magnetic>

                {[
                  { icon: Ruler, label: "Survey" },
                  { icon: Layers, label: "Structure" },
                  { icon: Mountain, label: "Geo" },
            ...
            <div className="space-y-10">
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="text-sm font-bold uppercase tracking-widest">Infrastructure Intelligence</span>
                </motion.div>
                <h2 className="text-4xl font-bold text-foreground sm:text-6xl leading-tight tracking-tight">
                  The Structural Core of <br />
                  <span className="text-primary italic">Modern Cities</span>
                </h2>
                <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
                  Experience an interactive civil-tech hub where planning, structure, safety and sustainability merge into one creative engineering ecosystem.
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-6 border-t border-border/50">
                <div className="group cursor-default">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-2xl font-black text-foreground tracking-tight group-hover:text-primary transition-colors">Smart Infrastructure</p>
                  </div>
                  <p className="text-sm text-muted-foreground leading-relaxed">Planning resilient and data-informed infrastructure for tomorrow’s needs.</p>
                </div>
                <div className="group cursor-default">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="h-2 w-2 rounded-full bg-accent animate-pulse" />
                    <p className="text-2xl font-black text-foreground tracking-tight group-hover:text-primary transition-colors">Sustainable Build</p>
                  </div>
                  <p className="text-sm text-muted-foreground leading-relaxed">Engineering practices focused on durability, safety, and environmental care.</p>
                </div>
              </div>

              <div className="pt-8">
                <button className="group relative inline-flex items-center gap-4 text-primary font-bold text-lg">
                  <span className="border-b-2 border-primary/30 group-hover:border-primary transition-all pb-1">Explore Civil Systems</span>
      ...
      >
        <div className="flex flex-col items-center gap-10 rounded-[40px] border border-border/40 bg-card/40 backdrop-blur-xl p-8 sm:flex-row sm:p-12 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex-1 text-center sm:text-left relative z-10">
            <p className="text-xs font-bold uppercase tracking-[0.5em] text-primary mb-3">Ready to Engineer Impact?</p>
            <h3 className="text-3xl font-bold text-foreground tracking-tight sm:text-5xl leading-tight">Build the Future with Civil Engineering</h3>
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed max-w-2xl">
              Join Satpuda Civil Engineering to create meaningful infrastructure, smarter communities and sustainable progress.
            </p>
          </div>
