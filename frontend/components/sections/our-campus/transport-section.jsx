...
import { Bus, MapPin, Route, ShieldCheck, Navigation, Clock, ArrowRight, Users, Sparkles, GraduationCap, X, Phone } from "lucide-react";
    ...
    <main className="bg-background pb-6 sm:pb-8 lg:pb-10">
      ...
      >
        <div className="flex flex-col items-center justify-between gap-8 rounded-[40px] border border-border/40 bg-gradient-to-r from-primary/10 to-accent/10 backdrop-blur-xl p-8 sm:flex-row sm:p-12 shadow-2xl relative overflow-hidden">
          ...
          <Magnetic intensity={0.3}>
            <button onClick={() => setIsPopupOpen(true)} className="group relative inline-flex items-center gap-3 rounded-full bg-primary px-10 py-5 text-lg font-bold text-primary-foreground transition-all hover:pr-12 shadow-xl shadow-primary/20">
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-4">
                    <div className="flex items-center gap-3 rounded-2xl border border-primary/20 bg-primary/5 px-6 py-3 w-full justify-center">
                      <span className="font-mono text-lg font-semibold tracking-wide text-foreground">+91 98765 43210</span>
                    </div>
